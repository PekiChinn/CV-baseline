...
from Paper.CV_baseline.DenseNet.tools.cifar10_dataset import CifarDataset
from Paper.CV_baseline.SENet.tools.common_tools import ModelTrainer, show_confMat, plot_line
from Paper.CV_baseline.SENet.tools.se_resnet import CifarSEBasicBlock
from Paper.CV_baseline.ResNet.tools.resnet import resnet20
...
if __name__ == "__main__":
    ...
    valid_loader = DataLoader(dataset=valid_data, batch_size=32, num_workers=8)
