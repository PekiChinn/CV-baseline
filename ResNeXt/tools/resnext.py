...
class ResNeXt(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        # stage: 2-5
        self.layer1 = self._make_layer(block, 64, layers[0])  # basic, 64, 3
...
# 代码复用，resnext整体结构未发生变化，因此可沿用resnet的结构
...
def resnext50_32x4d(pretrained=False, progress=True, **kwargs):
    ...
    # 这个参数传到 _resnet , 再传到ResNet，用于计算第二个卷积层的卷积核数量 width = int(planes * (base_width / 64.)) * groups
    return _resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3],
                   pretrained, progress, **kwargs)

resnext50_32x4d_model = resnext50_32x4d()
