...
from Paper.VGG.tools.my_dataset import CatDogDataset
from Paper.VGG.tools.common_tools import get_vgg16
...
if __name__ == "__main__":
    ...
    # 构建DataLoder
    train_loader = DataLoader(dataset=train_data, batch_size=BATCH_SIZE, num_workers=36, shuffle=True)
    valid_loader = DataLoader(dataset=valid_data, batch_size=4, num_workers=36)
